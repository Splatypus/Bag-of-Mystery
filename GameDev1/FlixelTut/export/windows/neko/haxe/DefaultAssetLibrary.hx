...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/rat front sheet.png", AssetType.IMAGE);
		path.set ("assets/images/rat sheet.png", "assets/images/rat sheet.png");
		type.set ("assets/images/rat sheet.png", AssetType.IMAGE);
		...
		type.set ("assets/sounds/Door.wav", AssetType.SOUND);
		path.set ("assets/sounds/Footstep.wav", "assets/sounds/Footstep.wav");
		type.set ("assets/sounds/Footstep.wav", AssetType.SOUND);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/rat front sheet.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/rat sheet.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/rat side sheet.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		id = "assets/sounds/Door.wav";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/sounds/Footstep.wav";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
